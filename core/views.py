...
from .utils import extract_pdf , summarizer,extract_and_generate,generate_pdf
    ...
    if request.method == "POST":
        ...
        if summary_form.is_valid():
            ...
            if input_file:
                ...
                # Generate PDF
                generate_pdf(output_text, temp_file_path)
                
                # Save temp_file to instance
                with open(temp_file_path, 'rb') as temp_file_content:
                    summary.generated_file.save("Generated_file.pdf", temp_file_content)
            ...
            # new_summary = Summary.objects.get(input_text=input_text)
            summary_detail_url = reverse_lazy("detail", kwargs={"pk": summary.pk})
